...
// prettier-ignore
import type { Methods as Methods0 } from './AccountId@string/academicHistories'
// prettier-ignore
import type { Methods as Methods1 } from './AccountId@string/applicants'
// prettier-ignore
import type { Methods as Methods2 } from './AccountId@string/followings'
// prettier-ignore
import type { Methods as Methods3 } from './AccountId@string/hopes'
// prettier-ignore
import type { Methods as Methods4 } from './AccountId@string/interestedLists'
// prettier-ignore
import type { Methods as Methods5 } from './AccountId@string/markAsRead'
// prettier-ignore
import type { Methods as Methods6 } from './AccountId@string/notifications'
// prettier-ignore
import type { Methods as Methods7 } from './AccountId@string/profile'
// prettier-ignore
import type { Methods as Methods8 } from './AccountId@string/rooms'
// prettier-ignore
import type { Methods as Methods9 } from './AccountId@string/workHistories'
// prettier-ignore
import type { Methods as Methods10 } from './Id@string'
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH10 = '/accounts/Id@string'
  const GET = 'GET'
  const POST = 'POST'
  const DELETE = 'DELETE'
  const PATCH = 'PATCH'
  ...
  return {
    ...
    Id_string: {
      ...
      patch: (option: { body: Methods10['patch']['reqBody'], config?: T | undefined }) =>
        fetch<Methods10['patch']['resBody'], BasicHeaders, Methods10['patch']['status']>(prefix, PATH10, PATCH, option).json(),
      /**
       * @returns OK
       */
      $patch: (option: { body: Methods10['patch']['reqBody'], config?: T | undefined }) =>
        fetch<Methods10['patch']['resBody'], BasicHeaders, Methods10['patch']['status']>(prefix, PATH10, PATCH, option).json().then(r => r.body),
      delete: (option?: { config?: T | undefined } | undefined) =>
        fetch<void, BasicHeaders, Methods10['delete']['status']>(prefix, PATH10, DELETE, option).send(),
      $delete: (option?: { config?: T | undefined } | undefined) =>
        fetch<void, BasicHeaders, Methods10['delete']['status']>(prefix, PATH10, DELETE, option).send().then(r => r.body),
      $path: () => `${prefix}${PATH10}`
    }
  }
}
